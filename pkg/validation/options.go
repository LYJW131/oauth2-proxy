...
func Validate(o *options.Options) error {
	...
	if o.AuthenticatedEmailsFile == "" && len(o.EmailDomains) == 0 && o.HtpasswdFile == "" && o.OTKUserMappingFile == "" {
		msgs = append(msgs, "missing setting for email validation: email-domain, authenticated-emails-file, or otk-user-mapping-file required."+
